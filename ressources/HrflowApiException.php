...
/**
 *  HrflowApiArgumentException occurs when arguments passed to a route
 *  are invalid (bad types, missing, ...).
 */
class HrflowApiArgumentException extends HrflowApiException
{
...
class HrflowApiWebhookException extends HrflowApiException
{
...
/**
 * HrflowApiResponseException occurs when the server responde an error code.
 * It containt the code and the reason.
 */
class HrflowApiResponseException extends HrflowApiException
{
...
class HrflowApiProfileUploadException extends HrflowApiException {
